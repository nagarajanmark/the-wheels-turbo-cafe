...
import { Gauge, Flame, Zap, ChevronDown } from "lucide-react";
...
export const HeroScrollSequence: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      const tl = gsap.timeline({
        scrollTrigger: {
          ...
          onUpdate: (self) => {
            ...
            else if (progress < 0.64) setCurrentStageNum(3);
      ...
      .fromTo(
        stage2Ref.current,
        { autoAlpha: 0, scale: 1.06, pointerEvents: "none" },
      ...
      .fromTo(
        stage4Ref.current,
        { autoAlpha: 0, scale: 0.94, pointerEvents: "none" },
        { autoAlpha: 1, scale: 1, pointerEvents: "auto", duration: 0.8 },
        "-=0.3"
      );
      ...
      .fromTo(
        stage5Ref.current,
        { autoAlpha: 0, scale: 0.95, y: 15, pointerEvents: "none" },
  ...
  return (
    ...
    >
      ...
      <div
        ref={bgGlowRef}
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[350px] sm:w-[700px] h-[350px] sm:h-[700px] rounded-full bg-racing-red/20 blur-[90px] sm:blur-[130px] pointer-events-none transition-all duration-500"
      />
